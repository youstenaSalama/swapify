...
import '../no_items_add_item_screen/widgets/conditioninput4_item_widget.dart';
...
class NoItemsAddItemScreen extends StatelessWidget {
  NoItemsAddItemScreen({Key? key}) : super(key: key);
  ...
  Widget _buildConditionInput(BuildContext context) {
    return Wrap(
        ...
        spacing: 6.h,
        children:
            List<Widget>.generate(2, (index) => Conditioninput4ItemWidget()));
  }
